...
Note: _for a successful print the rollers must be printed vertically and with the 45 degrees bearing shoulder facing down. I.e. like the roller on the left, below, not like the one on the right. Indeed, the other shoulder is 90 degrees and won't print properly if facing down._
